...
* [Страница раздела](templates/smartphones.html).
* [Страница незаполненного раздела](templates/empty_section.html).
* [Страница товара](templates/phone.html).
...
* Реализовать механизм анонимных отзывов как показано на макете [Страница товара](templates/phone.html).
